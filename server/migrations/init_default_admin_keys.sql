-- Initialize default admin key information
-- This script should be executed after adding the admin_keys table

-- Add default key information for existing admin users
...
SELECT 
    u.username,
    COALESCE('Default key set', 'Key exists') as key_status
FROM users u
LEFT JOIN admin_keys ak ON u.id = ak.admin_id
WHERE u.type = 'admin';